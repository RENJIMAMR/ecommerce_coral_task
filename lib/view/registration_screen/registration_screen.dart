...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(),
        body: GetBuilder(
          builder: (RegistrationScreenController controller) => Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (pass1_controller.text != null &&
                          pass1_controller.text.isNotEmpty &&
                          pass1_controller.text.length >= 5 &&
                          pass1_controller.text.length <= 12) {
                        return null;
                      } else {
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (pass1_controller.text == pass2_controller.text) {
                        return null;
                      } else {
                        return 'Pass words do not matching';
                      }
                    },
                    decoration: InputDecoration(
                        contentPadding:
